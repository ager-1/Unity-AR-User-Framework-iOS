...
public class UIController : ARFramework<UIController>
{
    ...
    {
        CanvasGroup panel;
        if (uiPanels.TryGetValue(name, out panel)) ChangeUI(uiPanels[name]);
        else Debug.LogError($"Undefined ui panel: {name}");
    }
