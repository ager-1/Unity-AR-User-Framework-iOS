...
{
    public enum InstructionUI { CrossPlatformFindAPlane, FindAFace, FindABody, FindAnImage, FindAnObject, ARKitCoachingOverlay, TapToPlace, None };
    ...
    void ShowInstructions()
    {
        switch (instruction)
        {
            ...
            case InstructionUI.ARKitCoachingOverlay:
                animationManager.ARKitCoachingOverlaySupported();
                break;
